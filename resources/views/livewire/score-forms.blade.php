    ...
    <form wire:submit.prevent='updateScore'>
        <div class="grid grid-cols-4 gap-4">
            <div>
                ...
                <input wire:model='value_ss' type="text" id="text"
            ...
            <div>
                ...
                <input wire:model='value_s' type="text" id="text"
            ...
            <div>
                ...
                <input wire:model='value_ks' type="text" id="text"
            ...
            <div>
                ...
                <input wire:model='value_ts' type="text" id="text"
